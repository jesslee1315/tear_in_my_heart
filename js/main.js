  ...
  $(document).ready(function() {
    ...
    function loader(){
      tl
      .to(pre_loader_logo, 4, {rotation:360, ease:Power0.easeNone})
      .to([title, pre_loader_logo], 1, {opacity:0 , ease:Power1.easeInOut})
      .add('red')
      .add('blue')

      .to(blue, 1.5, {x: 500, ease:Power1.easeInOut, opacity:0}, 'blue')
      .to(red, 1.5, {x: -500, ease:Power1.easeInOut, opacity:0}, 'red')
